...

{
  ...
  iVar1 = setvbuf(stdin,(char *)0x0,2,0);
  return iVar1;
}
...

  {
    ...
    fgets(message_input,4096,stdin); //overflow ret addr to email_input
...

{
  ...
  printf(">> ");
  __isoc99_scanf("%3s%*c",input1);
  yay_or_nay_check = strcmp(input1,"yay");
  if (yay_or_nay_check == 0) {
